...
namespace ComputerVisionQuickstart
{
    class Program
    {
        ...
        private string SubscriptionKey =>
            AzureUtilities.SecretManager.GetSecretValueWithManagedIdentity("<keyvault uri>", "<subscription key secret name>");

        // </snippet_vars>
        // </snippet_using_and_vars>

        // Download these images (link in prerequisites), or you can use any appropriate image on your local machine.
        private const string ANALYZE_LOCAL_IMAGE = @"C:\temp\20211010_173728.jpg";
        ...
        private const string ANALYZE_URL_IMAGE = "https://videoframestorage.blob.core.windows.net/video-frames/20211010_173728.jpg?sp=r&st=2022-01-01T18:03:04Z&se=2022-01-02T02:03:04Z&spr=https&sv=2020-08-04&sr=b&sig=UACyKWrE%2B4vUXrSRjWMX7YCCrMo0Zm15WG7CYH02es8%3D";
        // </snippet_analyze_url>
        ...
        static void Main(string[] args)
        {
            ...
            AnalyzeImageForFacesByUrl(client, ANALYZE_URL_IMAGE).Wait();
            // </snippet_main_calls>
        ...
        public static async Task AnalyzeImageAllFeaturesByUrl(ComputerVisionClient client, string imageUrl)
        {
            // Define the features to be extracted from the image
            ...
            await AnalyzeImageUrl(features, client, imageUrl);
        }

        public static async Task AnalyzeImageForFacesByUrl(ComputerVisionClient client, string imageUrl)
        {
         ...
         */
        public static async Task AnalyzeImageUrl(List<VisualFeatureTypes?> features, ComputerVisionClient client, string imageUrl)
        {
            Console.WriteLine("----------------------------------------------------------");
            ...
            if (results.Description is not null && results.Description.Captions is not null)
            {
            ...
            if (results.Categories is not null)
            {
            ...
            if (results.Objects is not null)
            {
            ...
            if (results.ImageType is not null)
            {
